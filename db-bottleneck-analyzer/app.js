...
function updateCheckout() {
  ...
  const provider = region.value === "jp" ? "Stripe" : "Polar";
  const pricePlans = {
    jp: { price: "14,900円（税込）", note: "priceJpNote", link: "stripeJapan" },
  ...
  button.disabled = !url;
  button.textContent = url ? t("buyNow") : t("salesPreparing");
