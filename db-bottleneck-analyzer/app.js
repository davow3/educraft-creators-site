...
Object.assign(translations.ja, {
  preview: "Windows版 v0.4.0", trialAvailable: "14日間無料試用", downloadTrial: "14日間無料で試す", unsignedNote: "現在のWindows版は未署名です。組織のセキュリティ規程に従い、まず検証端末で確認してください。", plannedPrice: "販売価格", postgresVersions: "PostgreSQL 14・17・18で接続・診断検証済み",
...
Object.assign(translations.id, {
  preview: "Windows v0.4.0", trialAvailable: "Uji coba gratis 14 hari", downloadTrial: "Coba gratis 14 hari", unsignedNote: "Build Windows saat ini belum ditandatangani. Ikuti kebijakan keamanan organisasi dan uji terlebih dahulu di perangkat evaluasi.", plannedPrice: "Harga", postgresVersions: "Koneksi dan diagnosis diuji dengan PostgreSQL 14, 17, dan 18", heroNote: "Instalasi tidak memulai masa uji coba. Semua fitur tersedia selama 14 hari setelah analisis database nyata pertama berhasil.",
...
Object.assign(translations.ko, {
  preview: "Windows v0.4.0", trialAvailable: "14일 무료 체험", downloadTrial: "14일 무료로 사용", unsignedNote: "현재 Windows 빌드는 코드 서명이 없습니다. 조직의 보안 규정에 따라 검증 장치에서 먼저 확인하세요.", plannedPrice: "판매 가격", postgresVersions: "PostgreSQL 14, 17, 18 연결 및 진단 검증 완료", heroNote: "설치만으로 체험 기간이 시작되지 않습니다. 실제 DB의 첫 진단 성공 시점부터 14일간 모든 기능을 사용할 수 있습니다.",
